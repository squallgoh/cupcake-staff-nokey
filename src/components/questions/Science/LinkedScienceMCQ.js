...
import { SCIENCE_SUBJECT_ID, QT_SCIENCE_LINKED_MCQ_ID } from "../_config.json";
      ...
      const { data } = await API.graphql(
        graphqlOperation(listQuestionsByTopicByQuestionTypeByLevel, {
          ...
          questionTypeIDLevelID: {
            eq: { questionTypeID: QT_SCIENCE_LINKED_MCQ_ID, levelID },
          },
        })
      );
      setQuestionList(data.listQuestionsByTopicByQuestionTypeByLevel.items);
    } catch (e) {
      console.error(e);
    }
  };
